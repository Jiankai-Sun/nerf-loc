...
class APCalculator(object):
    ...
    def step(
        ...
        # print('batch_pred_map_cls: {}, len(batch_pred_map_cls): {} \nbatch_gt_map_cls: {}, len(batch_gt_map_cls): {}'
        #       .format(batch_pred_map_cls, len(batch_pred_map_cls), batch_gt_map_cls, len(batch_gt_map_cls)))
